...
export default class AudioManager {
    ...
    async startMicrophoneInput() {
        try {
            console.log('[AudioManager] Starting microphone input...');
            ...
            if (this.sound && this.sound.isPlaying) {
                this.sound.stop();
                console.log("[AudioManager] Stopped file playback for microphone input.");
            }
            ...
            if (this.audioAnalyser) {
                ...
                } catch(e) { console.warn("[AudioManager] Error disconnecting THREE analyser:", e);}
                this.audioAnalyser = null; 
            }
            ...
            console.log(`[AudioManager] ✅ Microphone connected. FFT size: ${fftSize}`);
            
            // Test the analyser
            setTimeout(() => {
                const testFreq = this.getAverageFrequency();
                console.log('[AudioManager] Test microphone frequency:', testFreq);
            }, 500);
